        ...
        <body> 
            <div class="fixed-header"> 
                ...
                <nav class="main-menu vpadding"> 
                    <ul> 
                        <li>
                            <a class="external" href="${pageContext.request.contextPath }/">HOME</a>
                        </li>                     
                        <li>
        ...
        <div id="v" class="container-fluid nopadding"> 
            ...
            <section class="col-md-12 col-lg-12 nopadding" id="home"> 
                <div class="row flex-row" style="background-color:#0066cc; ">
                    ...
                    <div class="col-md-8 nopadding" style="float:right;">
                        <img id="heroImage" src="images/we_are_one8.jpg" alt="we_are_one8" class="img-responsive img-height" />
                    </div>
                </div>             
            </section>
                ...
                <div class="row row-white" style="padding-bottom:25px;">
                    ...
                    <div class="col-md-10">
                        <div align="center" style="padding-bottom:10px;">
                            <img class="center-block" src="images/arrow_image.png" alt="Arrow"/> 
                        </div>
            ...
            <section class="col-md-12 col-lg-12 nopadding" id="analtyics"> 
                <div class="row flex-row" style="background-color:#ffcc00;">
                    <div class="col-md-8 nopadding row-grey">
                        <img id="section3" src="images/driven_by_analtyics.jpg" alt="Driven by analtyics" class="img-responsive img-height" /> 
                    </div>
                    <div class="col-md-4 valign">
                        <div>
                ...
                <div class="row row-white" style="padding-bottom:25px;">
                    ...
                    <div class="col-md-10">
                        <div align="center" style="padding-bottom:20px;">
                            <img class="center-block" src="images/cube_image.png" alt="We believe you deserve to know"/> 
                        </div>
                        <div class="col-md-2 nopadding"></div> 
                        <div class="col-md-8 nopadding">
            ...
            <section class="col-md-12 col-lg-12 nopadding" id="usersfirst"> 
                <div class="row flex-row" style="background-color:#ff3333; ">
                    ...
                    <div class="col-md-8 nopadding" style="float:right;">
                        <img id="heroImage" src="images/users_first.jpg" alt="users first" class="img-responsive img-height" />
                    </div>
                </div>             
            </section>
