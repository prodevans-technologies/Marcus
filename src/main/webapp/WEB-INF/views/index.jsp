            ...
            <section class="col-md-12 col-lg-12 nopadding" id="home"> 
                <div class="row flex-row" style="background-color:#ffcc00; ">
                    ...
                    <div class="col-md-8 nopadding" style="float:right;">
                        <img id="heroImage" src="images/v1080x600.jpg" alt="Never Stop" class="img-responsive img-height" />
                    </div>
                </div>             
            </section>
                ...
                <div class="row row-white" style="padding-bottom:25px;">
                    ...
                    <div class="col-md-10">
                        <div align="center" style="padding-bottom:20px;">
                            <img style="height: 70px; widows: 150px" id="money" src="images/no_hidden_cost2.PNG" alt="No hidden cost" class="img-responsive " /> 
                        </div>
                                            ...
                                            <div class="carousel-inner">
                                                <div class="item active">
                                                    <div class="carousel-content">
                                                        <div>
                                                            <img id="section3" src="images/cpe_img1.png" alt="One8 cpe_img" class="img-responsive img-contain" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="item">
                                                    <div class="carousel-content">
                                                        <div>
                                                            <img id="section3" src="images/cpe_img2.png" alt="One8 cpe_img" class="img-responsive img-contain" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="item">
                                                    <div class="carousel-content">
                                                        <div> 
                                                            <img id="section3" src="images/cpe_img3.png" alt="One8 cpe_img" class="img-responsive img-contain" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="item">
                                                    <div class="carousel-content">
                                                        <div>
                                                            <img id="section3" src="images/cpe_img4.png" alt="One8 cpe_img" class="img-responsive img-contain" />
                                                        </div>
                                                    </div>
                                                </div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-109149551-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-109149551-1');
</script>
</html>